/** 
 * AGNITIO FRAMEWORK MODULE - references
 * A reference module that connect references to slides or
 * any other view (i.e. popup).
 * This module will try to fetch reference data from
 * a html file with a name matching the currently set reference.
  ...
  References.prototype = {
    init: function() {
      ...
      document.addEventListener('slideEnter', function() {
        self.set(app.slideshow.current);
      });
